      ...
      >
        <div style={{ textAlign: "center", padding: "20px 0" }}>
          ...
          <p style={{ fontSize: "14px", color: "#666" }}>
            This step requires validation before continuing.
          </p>
        </div>
      </Modal>
      <Wizard.Step
        validate={(params) => {
          if (params.actionType && params.actionType === "validate") {
            setOpen(true);
            return;
          }
          params.resolve();
...
const Validation = () => {
  const codeExample = `import { Modal } from "antd";
import { useState } from "react";
import {
  createWizardClient,
  useStep,
    ...
    <>
      ...
      >
        <div>
          ...
          <p>This step requires validation before continuing.</p>
        </div>
      </Modal>
      <Wizard.Step
        validate={(params) => {
      ...
      >
        <div>Step One - Requires Validation</div>
      </Wizard.Step>
    </>
  );
};
  ...
  return (
    <div>
      <p style={{ marginBottom: "16px", color: "#666" }}>
        This wizard demonstrates step validation functionality. Step One
        requires user confirmation before proceeding to the next step.
      </p>
