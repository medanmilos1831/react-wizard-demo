...
const StepThree = () => {
  return <div>Step Three - Added Dynamically</div>;
};
  ...
  return (
    <div>
      <p style={{ marginBottom: "16px", color: "#666" }}>
        This wizard demonstrates dynamic step addition. Step Three is added
        dynamically when you proceed from Step Two.
      </p>
